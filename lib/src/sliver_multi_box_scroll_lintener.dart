...
class SliverMultiBoxScrollListener extends StatefulWidget {
  final Widget Function(BuildContext context, double itemLength,
      double displayedLength, double parentDisplayRate) builder;
  final Widget child;
  final void Function(double itemLength, double displayedLength) onScrollInit;
  final void Function(ScrollUpdateNotification notification, double itemLength,
      double displayedLength) onScrollUpdate;
  final void Function(ScrollEndNotification notification, double itemLength,
      double displayedLength) onScrollEnd;
...
class _State extends State<SliverMultiBoxScrollListener>
    with ScrollItemOffsetMixin {
  ...
  void refreshDisplayPercent() {
    ...
    calculateDisplayPercent(context, widget.topOverlapCompensation,
        widget.bottomOverlapCompensation);
  ...
  Widget build(BuildContext context) {
    return widget.builder != null
        ? widget.builder(
            context, itemLength, displayedLength, parentDisplayRate)
        : widget.child;
  }
